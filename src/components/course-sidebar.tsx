...
import { CheckCircle2, Circle, PlayCircle, FileText, PenTool, File } from "lucide-react"
...
export function CourseSidebar({ courseId, modules, progress }: CourseSidebarProps) {
  ...
  return (
    <div className="w-full md:w-80 bg-card border-r border-border flex flex-col h-screen">
      {/* Header fijo */}
