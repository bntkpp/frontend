...
export function CourseCard({
  ...
  const savings4Months = calculateSavings(price_1_month, price_4_months, 4)
      ...
      <CardContent className="flex-1">
        ...
        <Tabs defaultValue="1_month" className="w-full">
          <TabsList className="grid w-full grid-cols-3">
            ...
            <TabsTrigger value="4_months" className="text-xs">4 Meses</TabsTrigger>
            <TabsTrigger value="8_months" className="text-xs">8 Meses</TabsTrigger>
          </TabsList>
          
          <TabsContent value="1_month" className="space-y-2 mt-4">
            <div className="flex items-baseline justify-center gap-1">
              <span className="text-3xl font-bold">
                ${price_1_month.toLocaleString("es-CL")}
              </span>
          ...
          <TabsContent value="4_months" className="space-y-2 mt-4">
            <div className="flex flex-col items-center">
              <div className="flex items-baseline gap-1">
                <span className="text-3xl font-bold">
                  ${price_4_months.toLocaleString("es-CL")}
                </span>
              </div>
              <div className="flex items-center gap-2 mt-1">
                <span className="text-sm text-muted-foreground">
                  ${(price_4_months / 4).toLocaleString("es-CL")}/mes
                </span>
          ...
          <TabsContent value="8_months" className="space-y-2 mt-4">
            <div className="flex flex-col items-center">
              <div className="flex items-baseline gap-1">
                <span className="text-3xl font-bold">
                  ${price_8_months.toLocaleString("es-CL")}
                </span>
              </div>
              <div className="flex items-center gap-2 mt-1">
                <span className="text-sm text-muted-foreground">
                  ${(price_8_months / 8).toLocaleString("es-CL")}/mes
                </span>
